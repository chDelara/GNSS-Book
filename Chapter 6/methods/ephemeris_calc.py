...
def calcSatBias(rcvr_df,eph_df,epoch,SV):

    ### coordinates of SV
    sv_n = rcvr_df[(rcvr_df['SV'] == SV) & (rcvr_df['time_week'] == epoch)]
    
    t =  sv_n.time_week.values - sv_n.pseudorange.values/c
    
    eph_n = eph_df[eph_df['SV'] == SV]
    epoch_idx = abs(eph_n.time_week - epoch).idxmin()
...
def calcSatPos(rcvr_df,eph_df,epoch,SV):

    ### coordinates of SV
    sv_n = rcvr_df[(rcvr_df['SV'] == SV) & (rcvr_df['time_week'] == epoch)]
    
    t =  sv_n.time_week.values - sv_n.pseudorange.values/c - calcSatBias(rcvr_df,eph_df,epoch,SV)
